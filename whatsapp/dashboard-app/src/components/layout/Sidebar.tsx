...
export function Sidebar({
  ...
  return (
    <>
      <div
        className={cn(
          'fixed inset-0 z-40 bg-[rgba(18,50,74,0.35)] transition lg:hidden',
      ...
      <aside
        ...
        className={cn(
          ...
          'fixed left-0 top-0 h-dvh lg:static lg:h-auto lg:min-h-full lg:self-stretch lg:translate-x-0',
